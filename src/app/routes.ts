import React from 'react';import { createBrowserRouter } from 'react-router-dom';import { WelcomeScreen } from './components/WelcomeScreen';import { RoleSelectionScreen } from './components/RoleSelectionScreen';import { LoginScreen } from './components/LoginScreen';import { OTPVerificationScreen } from './components/OTPVerificationScreen';import { DashboardRouter } from './components/DashboardRouter';import { LogisticsOperatorDashboard } from './components/LogisticsOperatorDashboard';import { CityPlannerDashboard } from './components/CityPlannerDashboard';import { VehicleDriverDashboard } from './components/VehicleDriverDashboard';import VehicleTracker from './components/VehicleTracker';import OperatorDeliveriesPage from './OperatorDeliveriesPage';export const router = createBrowserRouter([
