...
export const router = createBrowserRouter([
  ...
  { path: "/dashboard/vehicle-driver", element: React.createElement(Navigate, { to: "/dashboard/vehicle-driver/vehicle-001", replace: true }) },
  ...
  { path: "/dashboard/vehicle-driver/:driverId", element: React.createElement(VehicleDriverDashboard) },
